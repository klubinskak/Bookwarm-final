    ...
    $.ajax({
        ...
        success: function (data) {
            for (i = 0; i < data.items.length; i++) {
                ...
                cardbody.innerHTML = `
                <div class="card d-flex" style="margin:50px; width: 18rem;">
                <img class="card-img-top align-items-center mx-auto thumbnail imgs" src="${extractThumbnail(data.items[4].volumeInfo)}" style="width:170px; height:230px;" alt="">
                <div class="card-body">
                    <h5 class="card-title" style="font-weight:bold;">${data.items[4].volumeInfo.title}</h5>
                </div>
                <button type="button" class="display-review btn btn-dark mb-2" id="display-review" style="height:2.5rem; width: 150px; margin-left: 50px;" value='${data.items[4].volumeInfo.title}' data-toggle="modal" data-target="#mymodal">Display review</button>
                            <div class="modal" id="mymodal" tabindex="-1" role="dialog">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                            ...
                            <div class="dropdown " style="margin-right:8px;">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                <button class="dropdown-item iWantToRead" id = "iWantToRead" value='${data.items[4].volumeInfo.title}' data-value="${data.items[4].volumeInfo.imageLinks.thumbnail}" type="button">I want to read</button>
                                <button class="dropdown-item read" type="button" id="read" value='${data.items[4].volumeInfo.title}' data-value="${data.items[4].volumeInfo.imageLinks.thumbnail}">Read</button>
                                <button class="dropdown-item buy" type="button"  value='${data.items[4].volumeInfo.title}' data-value="${data.items[4].volumeInfo.imageLinks.thumbnail}">I want to buy</button>
                                </div>
                            </div>       
                            <button type="button" class="btn-review btn btn-dark" style="height:2.5rem; margin-right: 7px" data-toggle="modal" id="modal" value='${data.items[4].volumeInfo.title}' data-target="#exampleModal" data-whatever="@mdo">Review</button>
                            <a href="${data.items[4].accessInfo.webReaderLink}" class="btn mx-auto btn-dark" style="height:2.5rem;">Read</a>
                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                  ...
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" id="close" data-dismiss="modal">Close</button>
                                    <button type="button" id="add-review" name="add-review" value='${data.items[4].volumeInfo.title}' class="btn btn-primary"><a style="text-decoration: none; color: white;">Add review</a></button>
                                  </div>
                                </div>
                              </div>
                            </div>
    ...
    $.ajax({
        ...
        success: function (data) {
            for (i = 0; i < data.items.length; i++) {
                ...
                <div class="card d-flex" style="margin:50px; width: 18rem;">
                <img class="card-img-top align-items-center mx-auto thumbnail imgs" src="${extractThumbnail(data.items[1].volumeInfo)}" style="width:170px; height:230px;" alt="">
                <div class="card-body">
                    <h5 class="card-title" style="font-weight:bold;">${data.items[1].volumeInfo.title}</h5>
                </div>
                <button type="button" class="display-review btn btn-dark mb-2" id="display-review" style="height:2.5rem; width: 150px; margin-left: 50px;" value='${data.items[1].volumeInfo.title}' data-toggle="modal" data-target="#mymodal">Display review</button>
                            <div class="modal" id="mymodal" tabindex="-1" role="dialog">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                            ...
                            <div class="dropdown " style="margin-right:8px;">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                <button class="dropdown-item iWantToRead" id = "iWantToRead" value='${data.items[1].volumeInfo.title}' data-value="${data.items[1].volumeInfo.imageLinks.thumbnail}" type="button">I want to read</button>
                                <button class="dropdown-item read" type="button" id="read" value='${data.items[1].volumeInfo.title}' data-value="${data.items[1].volumeInfo.imageLinks.thumbnail}">Read</button>
                                <button class="dropdown-item buy" type="button"  value='${data.items[1].volumeInfo.title}' data-value="${data.items[1].volumeInfo.imageLinks.thumbnail}">I want to buy</button>
                                </div>
                            </div>       
                            <button type="button" class="btn-review btn btn-dark" style="height:2.5rem; margin-right: 7px" data-toggle="modal" id="modal" value='${data.items[1].volumeInfo.title}' data-target="#exampleModal" data-whatever="@mdo">Review</button>
                            <a href="${data.items[1].accessInfo.webReaderLink}" class="btn mx-auto btn-dark" style="height:2.5rem;">Read</a>
                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                  ...
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" id="close" data-dismiss="modal">Close</button>
                                    <button type="button" id="add-review" name="add-review" value='${data.items[1].volumeInfo.title}' class="btn btn-primary"><a style="text-decoration: none; color: white;">Add review</a></button>
                                  </div>
                                </div>
                              </div>
                            </div>
